...
bl_info = {
    "name": "SDF.R",
    "author": "hinata_hugu",
    "version": (15, 9, 9, 4),  # V15.9.9.4: preview draw caching + interactive step reduction + mesh-OFF early-out
    "blender": (4, 0, 0),
...
print(f"SDF.R: Loader Marker V15.9.9.1 (__init__.py loaded from: {__file__})")
...
# V15.9.9.1: DCコンパイル等のエラー診断文字列 (未発生時はNone)
...
def register():
    ...
    print("SDF.R: --- Initializing GPU Engine (V15.9.9.1) ---")
    ...
    def background_init():
        ...
        print(f"SDF.R: --- Starting GPU Warming-up (V15.9.9.1) ---")
        try:
