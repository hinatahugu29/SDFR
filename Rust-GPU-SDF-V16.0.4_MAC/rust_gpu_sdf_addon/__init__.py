...
bl_info = {
    "name": "SDF.R",
    "author": "hinata_hugu",
    "version": (16, 0, 4),  # V16.0.4: Gyroid phase and axis scaling
    "blender": (4, 0, 0),
...
print(f"SDF.R: Loader Marker V16.0.4 (__init__.py loaded from: {__file__})")
if _LAYOUT_DEBUG_ON:
...
def register():
    ...
    print("SDF.R: --- Initializing GPU Engine (V16.0.4) ---")
    ...
    def background_init():
        ...
        print(f"SDF.R: --- Starting GPU Warming-up (V16.0.4) ---")
        try:
