...
class SDF_OT_apply_material_all(bpy.types.Operator):
    ...
    bl_description = "Apply shared Metallic and Roughness values to all SDF primitives"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def execute(self, context):
        ...
        try:
            ...
            pass
        self.report({'INFO'}, f"Applied material values to {count} primitives.")
        return {'FINISHED'}
