...
bl_info = {
    "name": "SDF.R",
    "author": "hinata_hugu",
    "version": (16, 2, 2),  # V16.2.2: mirror blend preview matched to the final mesh
    "blender": (4, 0, 0),
...
print(f"SDF.R: Loader Marker V16.2.2 (__init__.py loaded from: {__file__})")
if _LAYOUT_DEBUG_ON:
...
def register():
    ...
    print("SDF.R: --- Initializing GPU Engine (V16.2.2) ---")
    ...
    def background_init():
        ...
        print(f"SDF.R: --- Starting GPU Warming-up (V16.2.2) ---")
        try:
