# SDF.R V16.2.0 UI / Command Inventory

対象: **Rust-GPU-SDF / SDF.R V16.2.0** \| 作成日: 2026-07-19 \| 用途: UIボタン・主要コントロールの棚卸し資料
...
Source basis: `rust_gpu_sdf_addon/ui.py`, `operators.py`, `properties.py`, `constants.py` in Rust-GPU-SDF-V16.2.0.
