# SDF.R V16.2.2 Workflow Examples

対象: **Rust-GPU-SDF / SDF.R V16.2.2** \| 作成日: 2026-07-19 \| 更新日: 2026-09-12 \| 用途: 想定ワークフロー例・制作手順集
...
Source basis: SDF.R V16.2.2 UI behavior and current implementation notes. Companion document: `SDF_R_V16_2_2_Comprehensive_User_Guide_JP.md` (第10章にLayer Boundaryの詳細、第0章にSDFツリーの詳細).
